  ...
  return (
    <div className='flex flex-col h-screen'>
      ...
      <div className='flex-1 bg-[#fafafa] overflow-hidden relative'>
            ...
            <div className='w-full space-y-8'>
              <div className='space-y-4'>
                ...
                <p className='text-gray-600'>
                  ...
                  image, click <Paperclip className='inline-block w-4 h-4' />{' '}
        ...
        {/* Floating input bar */}
        <div className='absolute bottom-0 left-0 right-0 border-t border-gray-200 bg-white bg-opacity-90 backdrop-blur'>
